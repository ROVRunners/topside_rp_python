...
class ROVConfig:
    ...
    def __init__(self) -> None:
        ...
        self.pins: dict[str, Pin] = {
            enums.ThrusterPositions.FRONT_LEFT: Pin(PinConfig(id=21, mode="PWMus", val=1500, freq=50)),
            enums.ThrusterPositions.FRONT_RIGHT: Pin(PinConfig(id=20, mode="PWMus", val=1500, freq=50)),
            enums.ThrusterPositions.REAR_LEFT: Pin(PinConfig(id=26, mode="PWMus", val=1500, freq=50)),
            enums.ThrusterPositions.REAR_RIGHT: Pin(PinConfig(id=16, mode="PWMus", val=1500, freq=50)),
            enums.ThrusterPositions.FRONT_VERTICAL: Pin(PinConfig(id=19, mode="PWMus", val=1500, freq=50)),
            enums.ThrusterPositions.REAR_VERTICAL: Pin(PinConfig(id=13, mode="PWMus", val=1500, freq=50)),
